	...
	<h4 style="font-family:tahoma;">Payroll Summary</h4>
	<h4 style="font-family:tahoma;">Pay Period : <?php 
	...
	<h4 style="font-family:tahoma;">Branch :
	<?php 
	if(count($payroll_register_summary)!=0){
	echo $get_branch;
	}
	...
	<table class="table" style="font-size:20pt;font-family:tahoma;">
		<thead>
			<tr>
		...
		<tbody>
			...
			<tr>
                ...
                <td align="center"><?php $otherdeducttemp = $this->db->query('SELECT COALESCE(SUM(deduction_amount),0) as total_other_deductions FROM pay_slip_deductions
																			...
																			WHERE refdeduction.deduction_type_id!=1 AND refdeduction.deduction_type_id!=2 AND refdeduction.deduction_type_id!=4
			...
			<?php
				...
				$salaries_wages = $gross_pay-$s_deductions;
					...
					<tr style="height:7px;"><td colspan="3" style="font-family:tahoma;font-size:30pt;font-weight:bold;">Payroll Summary</td></tr>
					<tr style="height:7px;">
