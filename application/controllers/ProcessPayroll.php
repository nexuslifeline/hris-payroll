...
class ProcessPayroll extends CORE_Controller
{
    ...
    function __construct() {
        ...
        if($this->session->userdata('right_processpayroll_view') == 0 || $this->session->userdata('right_processpayroll_view') == null) {
            redirect('../Dashboard');
        }
        else{
    ...
    public function index() {
       ...
       /* $data['refdeduction']=$this->RefDeductionSetup_model->get_list(array('refdeduction.is_deleted'=>FALSE));
        ...
        $this->load->view('process_payroll_view', $data);
    }
