...
/*
            ...
            case 'create':
                ...
                if ($ref_payment_type_id == 2)
                {
                  $m_daily_time_record->reg_amt = round($salary_rates/2);
                  $m_daily_time_record->for_13th_month = round($salary_rates);
                }
                else{
                  $m_daily_time_record->reg_amt = round($this->get_numeric_value($reg)*$per_hour_pay);
                  $m_daily_time_record->for_13th_month = round(104*$per_hour_pay);
                }
               /* $m_daily_time_record->for_13th_month = round($this->get_numeric_value($reg+$reg_hol+$spe_hol)*$per_hour_pay);*/
                // IF IT IS monthly
                /*if($semi_monthly_pay_type==1){
                    $m_daily_time_record->reg_amt = $this->get_numeric_value($semi_monthly_pay)/2;
                    $per_hour_pay = $per_hour_pay_temp/2;
                    echo $per_hour_pay;
                }*/
                // IF IT IS semi monthly
                /*elseif($semi_monthly_pay_type==2){
                    $m_daily_time_record->reg_amt = $this->get_numeric_value($reg);
                    $per_hour_pay = $per_hour_pay_temp;
                }*/
                // IF IT IS ?
                /*else{
                ...
                $m_daily_time_record->reg_hol_amt = ($this->get_numeric_value($reg_hol)*$per_hour_pay*$factor_file[0]->regular_holiday)/2;
                $m_daily_time_record->spe_hol_amt = ($this->get_numeric_value($spe_hol)*$per_hour_pay*$factor_file[0]->spe_holiday)/2;
